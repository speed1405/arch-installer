...
select_software() {
    INTERFACES=$(whiptail --title "Holocron Interfaces" --checklist "Select Desktop Environments and Window Managers:" 18 70 7 --separate-output \
    ...
    BUNDLES=$(whiptail --title "Holocron Knowledge" --checklist "Synchronize Knowledge Bundles:" 15 60 3 --separate-output \
